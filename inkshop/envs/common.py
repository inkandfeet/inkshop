...
CLUBHOUSE_BASE_URL = "clubhouse.%s" % INKSHOP_DOMAIN
MAIL_BASE_URL = "mail.%s" % INKSHOP_DOMAIN
DRAFT_BASE_URL = "draft.%s" % INKSHOP_DOMAIN
LOVE_BASE_URL = "love.%s" % INKSHOP_DOMAIN
DOTS_BASE_URL = "dots.%s" % INKSHOP_DOMAIN
