...
class DjangoFunctionalFactory:
    ...
    def rand_plant_name(cls):
        return RANDOM_PLANT_NAME_SOURCE[cls.rand_int(0, len(RANDOM_PLANT_NAME_SOURCE) - 1)].strip()

    @classmethod
    def rand_street_suffix(cls):
        return RANDOM_STREET_SUFFIX_SOURCE[cls.rand_int(0, len(RANDOM_STREET_SUFFIX_SOURCE) - 1)].strip()
    ...
    @classmethod
    def rand_color(cls):
        return RANDOM_COLOR_SOURCE[cls.rand_int(0, len(RANDOM_COLOR_SOURCE) - 1)].strip()
...
RANDOM_PLANT_NAME_SOURCE = [
    ...
    "Snowdrop", "Sorrel", "Sunflower", "SweetPea", "Tansy ", "Thistle", "Tiger-lily",
