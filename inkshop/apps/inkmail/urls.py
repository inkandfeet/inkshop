...
urlpatterns = [
    ...
    url(r'^transfer-subscription/(?P<opt_in_key>[0-9A-Za-z_\-]+)/$', views.transfer_subscription, name='transfer_subscription'),
    url(r'^confirm-subscription/(?P<transfer_code>[0-9A-Za-z_\-]+)/$', views.confirm_subscription, name='confirm_subscription'),
